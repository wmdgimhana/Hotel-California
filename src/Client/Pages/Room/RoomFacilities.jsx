  ...
  return (
    <div className="my-[100px] mx-[50px]">
      <motion.div
        ...
        className="flex shadow-xl transition-opacity flex-row-reverse hover:shadow-2xl justify-center items-center p-[20px] border-solid border-gray-100 border-[1px] bg-white rounded-md"
      >
